document.getElementById("signupForm")?.addEventListener("submit", async function (e) {
  ...
  const res = await fetch("https://musicplaylist-backend.onrender.com/api/auth/signup", {
    method: "POST",
    headers: {
...
document.getElementById("loginForm")?.addEventListener("submit", async function (e) {
  ...
  const res = await fetch("https://musicplaylist-backend.onrender.com/api/auth/login", {
    method: "POST",
    headers: {
      "Content-Type": "application/json",
    },
